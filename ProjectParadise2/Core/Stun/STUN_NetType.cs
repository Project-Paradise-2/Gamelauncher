namespace ProjectParadise2.Core.Stun
{
    ...
    class STUN_NatType
    {
        public static string GetType(STUN_NetType sTUN_NetType)
        {
            switch (sTUN_NetType)
            {
                case STUN_NetType.UdpBlocked:
                    return "Strict:UdpBlocked";
                case STUN_NetType.OpenInternet:
                    return "Open:OpenInternet";
                case STUN_NetType.SymmetricUdpFirewall:
                    return "Moderate:SymmetricUdpFirewall";
                case STUN_NetType.FullCone:
                    return "Open:FullCone";
                case STUN_NetType.RestrictedCone:
                    return "Moderate:RestrictedCone";
                case STUN_NetType.PortRestrictedCone:
                    return "Moderate:PortRestrictedCone";
                case STUN_NetType.Symmetric:
                    return "Moderate:Symmetric";
            }
            return "Strict:Unchecked";
        }
    }
}