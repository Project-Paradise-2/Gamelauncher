...
{
    /// <summary>
    /// Main window of the Project Paradise 2 launcher application.
    /// Provides user interface for navigation, profile display, and application controls.
    /// </summary>
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            this.CopyRight.Text = "© 2022 - " + DateTime.Now.Year + " Project Paradise 2";
            BackgroundWorker.OnLangset += SetLang;
            SetLang(null, null);
            BackgroundWorker.ReadArgs();
            DoWork();
        }

        /// <summary>
        /// Sets the language text for all UI elements based on current localization.
        /// </summary>
        ...
        private void SetLang(object sender, EventArgs e)
        {
            ...
            BTN_Home.Content = Lang.GetText(1);
            BTN_Settings.Content = Lang.GetText(2);
            BTN_Profile.Content = Lang.GetText(3);
            BTN_Service.Content = Lang.GetText(4);
            BTN_Info.Content = Lang.GetText(5);
            BTN_About.Content = Lang.GetText(6);
            BTN_Close.Content = Lang.GetText(7);
        }
